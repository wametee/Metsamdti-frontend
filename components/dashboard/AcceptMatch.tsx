...
export default function AcceptMatch({ onReject, onAccept }: AcceptMatchProps) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 text-center bg-[#FCF8F8] min-h-full overflow-y-auto">
